...
public class TestInitialization {
	...
	/**
	 * <summary>
	 * Before scenario to start up a new NewsAppsApplication. It also cleans up global static values
	 * as well as sets the test data values to the appropriate test data variable
	 * </summary>
	 * @param method
	 * @throws Exception
	 */
