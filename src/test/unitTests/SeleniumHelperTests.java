...
public class SeleniumHelperTests {
	...
	public void verifyClearAllTextByBackspacing_ExceptionThrown() {
			((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<input id=Test value=Testing></input>');");
			String test = "#Ha";
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<input id=Test value=Testing></input>');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("var script = document.createElement('script'); script.src = 'https://code.jquery.com/jquery-1.11.0.min.js'; script.type = 'text/javascript'; document.getElementsByTagName('head')[0].appendChild(script);");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<input id=Test class=className value=Testing></input>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<input id=Test name=name value=Testing></input>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<input id=Test class=Testing value=Testing></input>');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<input id=Test class=Testing value=Testing></input>');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("var script = document.createElement('script'); script.src = 'https://code.jquery.com/jquery-1.11.0.min.js'; script.type = 'text/javascript'; document.getElementsByTagName('head')[0].appendChild(script);");
		Thread.sleep(700);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test>Dont click this button</button>');");
		String test = "#Ha";
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test class=className >Dont click this button</button>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<a>Dont click this button</a>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test name=testName >Dont click this button</button>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test class=testClass >Dont click this button</button>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<div id=Test2><button id=Test class=testClass >Dont click this button</button></div>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<div id=Test2><button id=Test class=testClass >Dont click this button</button><button id=Test class=testClass >Dont click this button</button></div>');");
		Thread.sleep(500);
		WebElement test = sHelp.getElement("Test2", "id");
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<div id=Test class=testClass>Some Text</div>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<div id=Test class=testClass></div>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<div id=Test class=testClass >Testing123</div>');");
		Thread.sleep(500);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test class=testClass >Testing123</button>');");
		Thread.sleep(500);
		WebElement test = sHelp.getElement("Test", "id");
	...
	public void verifyNavigateToUrl() throws InterruptedException
	{
		...
		assertEquals("The url values do not match", "https://www.facebook.com/", LocalDriverManager.getDriver().getCurrentUrl());
	}
	...
	{
		sHelp.openANewTab();
		assertTrue("Total tabs open is not correct", LocalDriverManager.getDriver().getWindowHandles().size() == 2);
	}
	...
	public void verifyRefreshThePage()
	{
		...
		assertTrue("Total tabs open is not correct", LocalDriverManager.getDriver().getWindowHandles().size() == 1);
	}
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<select id=Test class=testClass ><option name=test>Test1</option><option>Test2</option><option>Test3</option><option>Test4</option><option>Test5</option></select>');");
		Thread.sleep(300);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<iframe id=\"Test\" src=\"demo_iframe.htm\" height=\"200\" width=\"300\"></iframe>');");
		Thread.sleep(300);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<div id=Test class=someClassValue></div>');");
		Thread.sleep(300);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test>Button</button>');");
		Thread.sleep(300);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test></button>');");
		Thread.sleep(300);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test>Button1</button>');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test>Button2</button>');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test2>Button3</button>');");
		Thread.sleep(300);
	...
	public void verifyDragAndDropViaSelenium_ThrowsException() throws InterruptedException
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test>Button1</button>');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test>Button2</button>');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<button id=Test2>Button2</button>');");
		Thread.sleep(300);
	...
	{
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<div id=\"resizer\" class=\"resizer ui-draggable ui-draggable-handle ui-resizable\" data-status=\"scheduled\" style=\"left: 548.792px; top: 0px; width: 10px; height: 26px; bottom: auto;\">');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("document.write('<div class=\"timeslot ui-droppable\" id=\"Ref_Encoder-02\" style=\"width: 1058px;\">');");
		((JavascriptExecutor)LocalDriverManager.getDriver()).executeScript("var script = document.createElement('script'); script.src = 'https://code.jquery.com/jquery-1.11.0.min.js'; script.type = 'text/javascript'; document.getElementsByTagName('head')[0].appendChild(script);");
		Thread.sleep(300);
