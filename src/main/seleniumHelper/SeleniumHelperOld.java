...
public class SeleniumHelperOld {
	...
	*/
    ...
    private void executeDragNDrop(String from, String dx, String dy, String stepWidth, String stepDelay) throws Exception
    {
    	try
    	{
    		((JavascriptExecutor)LocalDriver.getDriver()).executeScript("$('"+ from + "').simulate('drag-n-drop', {dx: "+ dx +", dy: "+ dy +", interpolation: {stepWidth: "+ stepWidth +", stepDelay: "+ stepDelay +"}})");
    	}
    	catch (Exception ex)
    	{
    		throw ex;
    ...
    private void executeDragNDrop(String from, String dx, String dy, String stepWidth, String stepDelay, String index) throws Exception
    {
    	try
    	{
    		((JavascriptExecutor)LocalDriver.getDriver()).executeScript("$('"+ from + "')["+ index + "].simulate('drag-n-drop', {dx: "+ dx +", dy: "+ dy +", interpolation: {stepWidth: "+ stepWidth +", stepDelay: "+ stepDelay +"}})");
    	}
    	catch (Exception ex)
    	{
    		throw ex;
   ...
   */
    ...
    public void switchToFrame(String frameName)
    {
    	try
    	{
    		LocalDriver.getDriver().switchTo().frame(frameName);
    	}
    	catch (Exception ex)
    	{
    		throw ex;
