...
public class ReportThemeFactory {
    ...
    public static ReportTheme GetReportsTheme(ReportThemeFactory.Theme theme)
    {
        ...
        switch (theme)
        {
            ...
            case COOL:
                {
                    reportTheme.setHeadingBackColor("#2b9cd8");
                    reportTheme.setHeadingForeColor("#FFFFFF");
                    reportTheme.setSectionBackColor("#D6D8D8");
                    reportTheme.setSectionForeColor("#000000");
                    reportTheme.setContentForeColor("#000000");
                    reportTheme.setContentBackColor("#FFFFFF");
                    break;
                }
        }
        return reportTheme;
