...
public class RandomStringHelper {
	...
	public RandomStringHelper(RandomStringBuilder builder) throws Exception {
		if (builder.stringArray != null
			...
			throw new Exception("Please provide either a string or a string array to be randomized.");
		}
	}
     ...
     * @throws Exception
     */
    public static String getRandomStringFromArray(RandomStringBuilder builder) throws Exception {
        	String result = null;
        	try {
     ...
     * @throws Exception
     */
    protected String createRandomStringFromCharacters(RandomStringBuilder builder) throws Exception {
