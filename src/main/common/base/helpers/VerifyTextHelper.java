...
public class VerifyTextHelper {
	...
	public VerifyTextHelper(VerifyTextBuilder builder) throws TestException {
		try {
			Validator.of(builder.expectedText)
					.validate(Objects::nonNull, result -> builder.expectedText != null, "Expected Text is null.").get();
	...
	/**
	 * <p>
	 * Method to verify some element contains the
	 * expected text.
	 * </p>
	 * <p>
	 * This method contains the functionality to
	 ...
	 * Newston application. It seemed easier to just
	 ...
	 * 
	 * @param element
	 *            - the webelement for the field that
	 *            the text will be compared against.
	 * @param expectedText
	 ...
	 *            validation needs to occur with all
	 *            spaces removed to produce a more
	 *            accurate comparison. Not neccesary
	 *            for all users of this method,
	 *            however has been necessary for some
	 *            instances.
	 * @throws TestException
	 */
	protected void verifySomeWebElementContainsTheExpectedText(VerifyTextBuilder builder) throws TestException {
		try {
	 ...
	 *            - boolean to determine whether
	 *            validation needs to occur with all
	 *            spaces removed to producce a more
	 *            accurate comparison. Not neccesary
	 *            for all consumers of this method,
	 *            however has been necessary for some
	 *            instances.
	 * @throws TestException
	 */
	...
	/**
	 * <p>
	 * Method to verify that text in a text field
	 * contains the expected text utilizing the
	 * javascript function of getting a value from a
	 * text box webelement.
	 * </p>
	 * <p>
	 * This method is typically only used for
	 ...
	 * is at any point returned in the actual text
	 * string that is retrieved from the element.
	 * </p>
	 * 
	 * @param locator
	 *            - the webelement locator string for
	 *            the field of the text being verified
	 * @param by
	 *            - the type of locator being used
	 *            (i.e id, name, csslocator, xpath,
	 *            etc.)
	 * @param webElementIndex
	 *            - the index of the element if there
	 *            are more than one elements with the
	 *            same locator. Leave this value null
	 *            to not include an index.
	 * @param expectedText
	 *            - the text that is expected to be in
	 *            the element
	 * @param elementBeingTested
	 ...
	 * @throws TestException
	 */
	protected void verifyTextInTextField(VerifyTextBuilder builder) throws TestException {
		try {
			String index = null;
